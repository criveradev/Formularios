...
class __TwigTemplate_bd312de792224b372480d1b89383acc6 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 class=\"d-flex align-items-center justify-content-between\">
        Ejemplo home! ✅

        <a href=\"";
        // line 9
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post_create");
        echo "\" class=\"btn btn-dark btn-sm\">Crear post</a>
    </h1>
...
\t\t\t\t<td>";
            ...
            echo "</td>
                <td>";
            // line 17
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "tittle", [], "any", false, false, false, 17), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 19
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 19)]), "html", null, true);
            echo "\">
                        Editar
                    </a>
                </td>
...
";
    ...
    {
        return array (  114 => 25,  102 => 19,  97 => 17,  93 => 16,  90 => 15,  86 => 14,  78 => 9,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1 class=\"d-flex align-items-center justify-content-between\">
        ...
        <a href=\"{{ path('post_create') }}\" class=\"btn btn-dark btn-sm\">Crear post</a>
    </h1>
...
{% endblock %}
", "page/index.html.twig", "/Users/crivera/Desktop/symfonyForm/templates/page/index.html.twig");
    }
}
